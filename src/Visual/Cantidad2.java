 ...
 * @author nello
 */
public class Cantidad2 extends javax.swing.JFrame {
private final Hamburguesa crear;
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        String SELECT = "Hamburguesa doble carne";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cantidad2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
