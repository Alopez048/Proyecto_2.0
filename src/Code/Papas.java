...
public class Papas {
    ...
    public void Papas(String TIPO ,  String PRESENTACION,  int COSTO, int CANTIDAD, int TOTAL)
    {
        
        try{
            Connection papas= nuevo.getConection();
            CallableStatement CS= papas.prepareCall("call insertPapas (?,?,?,?,?)");
